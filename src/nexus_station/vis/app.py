...
from nexus_station.utils.server import (
    find_available_port,
    format_url,
...
from nexus_station.vis.api import sessions_router, statistics_router, system_router
from nexus_station.web.api.open_in import router as open_in_router
...
def run_vis_server(
    ...
    uvicorn.run(
        "nexus_station.vis.app:create_app",
        factory=True,
        host=host,
        port=actual_port,
        reload=reload,
