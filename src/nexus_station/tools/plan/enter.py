...
from nexus_station.soul import get_wire_or_none, wire_send
from nexus_station.soul.toolset import get_current_tool_call_or_none
from nexus_station.tools.utils import load_desc
from nexus_station.wire.types import QuestionItem, QuestionNotSupported, QuestionOption, QuestionRequest
...
class EnterPlanMode(CallableTool2[Params]):
    ...
    def bind(
        ...
        *,
        ...
        """Late-bind soul callbacks after NexusSoul is constructed."""
