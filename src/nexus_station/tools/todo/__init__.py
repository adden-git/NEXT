...
from nexus_station.session_state import TodoItemState
from nexus_station.soul.agent import Runtime
from nexus_station.tools.display import TodoDisplayBlock, TodoDisplayItem
...
class SetTodoList(CallableTool2[Params]):
    ...
    def _write_subagent_state(path: Path, data: dict[str, Any]) -> None:
        from nexus_station.utils.io import atomic_json_write
