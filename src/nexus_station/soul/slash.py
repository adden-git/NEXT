...
import nexus_station.prompts as prompts
from nexus_station import logger
from nexus_station.soul import wire_send
from nexus_station.soul.agent import load_agents_md
from nexus_station.soul.context import Context
from nexus_station.soul.dynamic_injections.afk_mode import AFK_DISABLED_REMINDER
from nexus_station.soul.message import system, system_reminder
from nexus_station.utils.export import is_sensitive_file
from nexus_station.utils.path import sanitize_cli_path, shorten_home
from nexus_station.utils.slashcmd import SlashCommandRegistry
...
async def add_dir(soul: NexusSoul, args: str):
    ...
    from nexus_station.utils.path import is_within_directory, list_directory
