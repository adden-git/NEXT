...
from nexus_station.exception import InvalidToolError, MCPRuntimeError
from nexus_station.hooks.engine import HookEngine
from nexus_station.tools import SkipThisTool
...
if TYPE_CHECKING:
    ...
    def type_check(kimi_toolset: NexusToolset):
...
class NexusToolset:
    ...
    def handle(self, tool_call: ToolCall) -> HandleResult:
        ...
        try:
            ...
            async def _call():
                ...
                from nexus_station.telemetry import track as _track_tool_call
    ...
    def load_tools(self, tool_paths: list[str], dependencies: dict[type[Any], Any]) -> None:
        """
        Load tools from paths like `nexus_station.tools.shell:Shell`.
    ...
    async def load_mcp_tools(
        ...
        from nexus_station.mcp_oauth import create_mcp_oauth, has_mcp_oauth_tokens
...
class WireExternalTool(CallableTool):
    ...
    async def __call__(self, *args: Any, **kwargs: Any) -> ToolReturnValue:
        ...
        from nexus_station.soul import get_wire_or_none
