...
from nexus_station.agentspec import load_agent_spec
from nexus_station.approval_runtime import ApprovalRuntime
from nexus_station.auth.oauth import OAuthManager
from nexus_station.background import BackgroundTaskManager
from nexus_station.config import Config
from nexus_station.exception import MCPConfigError, SystemPromptTemplateError
from nexus_station.llm import LLM
from nexus_station.notifications import NotificationManager
from nexus_station.session import Session
from nexus_station.skill import (
    Skill,
...
from nexus_station.soul.approval import Approval, ApprovalState
from nexus_station.soul.denwarenji import DenwaRenji
from nexus_station.soul.toolset import NexusToolset
from nexus_station.subagents.models import AgentTypeDefinition, ToolPolicy
from nexus_station.subagents.registry import LaborMarket
from nexus_station.subagents.store import SubagentStore
from nexus_station.utils.environment import Environment
from nexus_station.utils.logging import logger
from nexus_station.utils.path import find_project_root, is_within_directory, list_directory
from nexus_station.wire.root_hub import RootWireHub
...
async def load_agent(
    ...
    *,
    ...
    # Load plugin tools
    from nexus_station.plugin.manager import get_plugins_dir
    from nexus_station.plugin.tool import load_plugin_tools
