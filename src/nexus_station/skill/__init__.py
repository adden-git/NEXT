...
from nexus_station.skill.flow import Flow, FlowError
from nexus_station.skill.flow.d2 import parse_d2_flowchart
from nexus_station.skill.flow.mermaid import parse_mermaid_flowchart
from nexus_station.utils.frontmatter import parse_frontmatter
...
def get_builtin_skills_dir() -> Path:
    ...
    if getattr(sys, "frozen", False) and hasattr(sys, "_MEIPASS"):
        ...
        return Path(meipass) / "nexus_station" / "skills"
...
def _first_meaningful_line(content: str) -> str | None:
    ...
    :mod:`nexus_station.utils.frontmatter`). A malformed frontmatter opener that
    ...
    """
    from nexus_station.utils.frontmatter import strip_frontmatter
