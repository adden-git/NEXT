...
from nexus_station.plugin import PluginError
...
def install_cmd(
    ...
    from nexus_station.plugin.manager import get_plugins_dir, install_plugin
    ...
    try:
        ...
        from nexus_station.llm import augment_provider_with_env_vars
        from nexus_station.plugin.manager import collect_host_values
...
def list_cmd() -> None:
    ...
    from nexus_station.plugin.manager import get_plugins_dir, list_plugins
...
def remove_cmd(
    ...
    from nexus_station.plugin.manager import get_plugins_dir, remove_plugin
...
def info_cmd(
    ...
    """Show plugin details."""
    from nexus_station.plugin import parse_plugin_json
