...
def _has_oauth_tokens(server_url: str) -> bool:
    ...
    from nexus_station.mcp_oauth import has_mcp_oauth_tokens
...
def mcp_auth(
    ...
    async def _auth() -> None:
        ...
        from nexus_station.mcp_oauth import prepare_mcp_server_config
...
def mcp_reset_auth(
    ...
    async def _reset_auth() -> None:
        from nexus_station.mcp_oauth import create_mcp_oauth_token_storage
