...
from nexus_station.hooks.config import HookDef
from nexus_station.llm import ModelCapability, ProviderType
...
class Config(BaseModel):
    ...
    telemetry: bool = Field(
        default=True,
        description="Enable anonymous telemetry to help improve nexus-station. Set to false to disable.",
    )
