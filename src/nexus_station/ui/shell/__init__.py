...
from nexus_station.background import list_task_views
...
from nexus_station.ui.shell.mcp_status import render_mcp_prompt
from nexus_station.ui.shell.prompt import (
    BgTaskCounts,
    CustomPromptSession,
    CwdLostError,
    PromptMode,
...
from nexus_station.ui.shell.replay import replay_recent_history
from nexus_station.ui.shell.slash import SKILL_COMMAND_PREFIX, shell_mode_registry
from nexus_station.ui.shell.slash import registry as shell_slash_registry
from nexus_station.ui.shell.update import LATEST_VERSION_FILE, UpdateResult, do_update, semver_tuple
from nexus_station.ui.shell.visualize import (
...
from nexus_station.utils.logging import open_original_stderr
from nexus_station.utils.signals import install_sigint_handler
from nexus_station.utils.slashcmd import SlashCommand, SlashCommandCall, parse_slash_command_call
from nexus_station.utils.subprocess_env import get_clean_env
from nexus_station.utils.term import ensure_new_line, ensure_tty_sane
...
class Shell:
    ...
    async def run(self, command: str | None = None) -> bool:
        ...
        _print_welcome_info(self.soul.name or "NEXUS Station", self._welcome_info)

        # Start telemetry periodic flush and disk retry
        from nexus_station.telemetry import get_sink
        ...
        with CustomPromptSession(
            ...
            try:
                while True:
                    ...
                    from nexus_station.ui.shell.visualize import InputAction, classify_input
    ...
    async def _run_btw_modal(
        ...
        """
        from nexus_station.soul.btw import execute_side_question
        from nexus_station.ui.shell.visualize import (
...
def _print_welcome_info(name: str, info_items: list[WelcomeInfoItem]) -> None:
    head = Text.from_markup("Welcome to NEXUS Station!")
    ...
    if LATEST_VERSION_FILE.exists():
        ...
        from nexus_station.ui.shell.update import SKIPPED_VERSION_FILE
        from nexus_station.utils.envvar import get_env_bool
