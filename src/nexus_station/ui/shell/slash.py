...
from nexus_station.auth.platforms import get_platform_name_for_provider, refresh_managed_models
...
from nexus_station.utils.changelog import CHANGELOG
from nexus_station.utils.slashcmd import SlashCommand, SlashCommandRegistry
...
def help(app: Shell, args: str):
    ...
    from nexus_station.utils.rich.columns import BulletColumns
...
async def model(app: Shell, args: str):
    ...
    from nexus_station.llm import derive_model_capabilities
...
async def editor(app: Shell, args: str):
    ...
    from nexus_station.utils.editor import get_editor_command
...
async def feedback(app: Shell, args: str):
    """Submit feedback to make NEXUS Station better"""
    import platform
    import webbrowser
    ...
    from nexus_station.auth.platforms import get_platform_by_id, managed_provider_key
    from nexus_station.constant import VERSION
...
async def list_sessions(app: Shell, args: str):
    ...
    from nexus_station.ui.shell.session_picker import SessionPickerApp
...
def theme(app: Shell, args: str):
    ...
    from nexus_station.ui.theme import get_active_theme
...
async def undo(app: Shell, args: str):
    ...
    from nexus_station.session_fork import enumerate_turns, fork_session
...
async def fork(app: Shell, args: str):
    ...
    from nexus_station.session_fork import fork_session
