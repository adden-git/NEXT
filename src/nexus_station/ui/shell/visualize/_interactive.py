...
from nexus_station.ui.shell.console import console, render_to_ansi
from nexus_station.ui.shell.echo import render_user_echo_text
from nexus_station.ui.shell.keyboard import KeyEvent
from nexus_station.ui.shell.prompt import (
    CustomPromptSession,
    UserInput,
)
from nexus_station.ui.shell.visualize._btw_panel import _BtwModalDelegate
from nexus_station.ui.shell.visualize._input_router import InputAction, classify_input
from nexus_station.ui.shell.visualize._live_view import _LiveView
    ...
    def handle_local_input(self, user_input: UserInput) -> None:
        ...
        match action.kind:
            ...
            case InputAction.QUEUE:
                ...
                from nexus_station.utils.slashcmd import parse_slash_command_call

                if cmd := parse_slash_command_call(user_input.resolved_command.strip()):
                    from nexus_station.ui.shell.slash import registry as shell_registry

                    if shell_registry.find_command(cmd.name) is not None:
                        from nexus_station.ui.shell.prompt import toast
