...
from nexus_station.soul import StatusSnapshot, format_context_status
from nexus_station.ui.shell import placeholders as prompt_placeholders
from nexus_station.ui.shell.console import console
from nexus_station.ui.shell.placeholders import (
    PromptPlaceholderManager,
    normalize_pasted_text,
    sanitize_surrogates,
)
from nexus_station.ui.theme import get_prompt_style, get_toolbar_colors
from nexus_station.utils.clipboard import (
    grab_media_from_clipboard,
    is_clipboard_available,
)
from nexus_station.utils.logging import logger
from nexus_station.utils.slashcmd import SlashCommand
from nexus_station.wire.types import ContentPart
...
class LocalFileMentionCompleter(Completer):
    ...
    :mod:`nexus_station.utils.file_filter` so that the web backend can reuse
    them.
    """
    ...
    def _get_top_level_paths(self) -> list[str]:
        from nexus_station.utils.file_filter import is_ignored
    ...
    def _get_deep_paths(self) -> list[str]:
        from nexus_station.utils.file_filter import (
            detect_git,
            git_index_mtime,
            list_files_git,
            list_files_walk,
...
class CustomPromptSession:
    ...
    def _open_in_external_editor(self, event: KeyPressEvent) -> None:
        ...
        from nexus_station.utils.editor import edit_text_in_editor, get_editor_command
