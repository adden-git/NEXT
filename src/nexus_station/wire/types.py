...
from nexus_station.tools.display import (
...
from nexus_station.utils.typing import flatten_union
...
class ApprovalRequest(BaseModel):
    ...
    # Note that the above fields are just a copy of `nexus_station.soul.approval.Request`, but
