...
from nexus_station.tools.shell import Params as ShellParams
from nexus_station.tools.shell import Shell
from nexus_station.tools.utils import ToolResultBuilder
from nexus_station.wire.types import DisplayBlock
...
class Terminal(CallableTool2[ShellParams]):
    ...
    async def __call__(self, params: ShellParams) -> ToolReturnValue:
        from nexus_station.acp.session import get_current_acp_tool_call_id_or_none
