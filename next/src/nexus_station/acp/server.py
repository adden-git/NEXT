...
from nexus_station.acp.kaos import ACPKaos
from nexus_station.acp.mcp import acp_mcp_servers_to_mcp_config
from nexus_station.acp.session import ACPSession
...
class ACPServer:
    ...
    async def new_session(
        ...
        if isinstance(cli_instance.soul.agent.toolset, NexusToolset):
            replace_tools(
