...
import { Settings, FolderOpen, Terminal } from "@/components/nexus-icons";
              ...
              <section>
                ...
                <div className="flex gap-2">
                  <a href="/files.html" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="sm" className="flex items-center gap-1.5"><FolderOpen className="size-4" /> File Manager</Button>
                  </a>
                  <a href="/ssh.html" target="_blank" rel="noopener noreferrer">
                    <Button variant="outline" size="sm" className="flex items-center gap-1.5"><Terminal className="size-4" /> SSH Terminal</Button>
                  </a>
                </div>
              </section>
            </div>
