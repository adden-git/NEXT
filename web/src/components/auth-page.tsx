...
import { Eye, EyeOff, Shield, User, Key, Copy, CheckCircle2 } from "lucide-react";
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="text-center space-y-2">
          <div className="flex items-center justify-center gap-2">
            ...
            <h1 className="text-xl font-bold">Kimi Next</h1>
          </div>
          ...
          <div className="space-y-4">
            ...
            {mode === "login" && (
              <p className="text-xs text-muted-foreground text-center">
                Если вы забыли пароль — удалите файл <code>~/.kimi/web_users.json</code> на сервере и перезапустите приложение.
              </p>
            )}
          </div>
        )}
